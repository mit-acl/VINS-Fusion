...
The realsense_stereo_imu_config_3 file has the calibration for the D435i camera and its IMU. The realsense_stereo_imu_config_4 file has the calibration for the camera and the 3dm IMU (The extrinsic calibration is not very accurate and can be imporved for the 3dm). The intrinsic calibration variables are generated with Kalibr using the Pinhole-radtan camera and distortion model. 
